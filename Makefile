...
C_FLAGS += -DMBED_BUILD_TIMESTAMP=1549900072.2
...
CXX_FLAGS += -DMBED_BUILD_TIMESTAMP=1549900072.2
...
ASM_FLAGS += -include
ASM_FLAGS += /filer/workspace_data/exports/a/a5c185198d77ac2a8d68c1f1e807db1c/mbed_blinky/mbed_config.h
ASM_FLAGS += -x
ASM_FLAGS += assembler-with-cpp
ASM_FLAGS += -c
ASM_FLAGS += -Wall
